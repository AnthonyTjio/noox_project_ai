...
class DurationRecorder:
	...
	@classmethod
	def al_epoch_logger(cls, validation, acc, loss, log_dir="./training.log", csv_dir="./training_log.csv"):	
		"""
		...
		if csv_dir is not None:
			data = np.array([validation, diff, loss, acc, hour, minute, second])
	...
	@classmethod
	def al_epoch_plotter(cls, validation, acc, loss):
		"""
		...
		cls.validation_list.append(validation)
		...
		plt.plot(cls.validation_list, cls.loss_list, c="red")
		...
		plt.plot(cls.validation_list, cls.acc_list, c="blue")
		...
		plt.plot(cls.validation_list, cls.diff_list, c="green")
	...
	@classmethod
	def pr_epoch_logger(cls, validation, precision, recall, log_dir="./training.log", csv_dir="./training_log.csv"):	
		"""
		...
		if csv_dir is not None:
			data = np.array([validation, diff, precision, recall, hour, minute, second])
	...
	@classmethod
	def pr_epoch_plotter(cls, validation, precision, recall, log_dir="./training.log", csv_dir="./training_log.csv"):
		"""
		...
		plt.plot(cls.validation_list, cls.prec_list, c="red")
		...
		plt.plot(cls.validation_list, cls.recall_list, c="blue")
